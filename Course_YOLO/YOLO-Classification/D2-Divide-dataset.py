...
if __name__ == '__main__':
    src_data_folder = r'./datasets/GarbageClassification'
    target_data_folder = r'./datasets/garbage'
    data_set_split(src_data_folder, target_data_folder, train_scale=0.8, val_scale=0.2)
