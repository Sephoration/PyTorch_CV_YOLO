...
# ==========================================
# 2. 前端核心：布局方案 3（精美页脚签名版）
# ==========================================
class VisionWorkstationGUI(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("计算机视觉综合实验工作站 - 布局方案 3")
    ...
    def init_ui(self):
        ...
        self.logo_label.setFixedSize(140, 140)  # 微调为紧凑的 140x140 正方形
        ...
        top_header_layout.addWidget(self.param_tabs)
        ...
        self.view_raw.setScaledContents(True)  # 自适应内容缩放，彻底解决窗口无限变大BUG
        ...
        # ----------------------------------------------------
        # 布局 C: 底部学院长条页脚标题栏 (Footer)
        # ----------------------------------------------------
        footer_layout = QHBoxLayout()

        title_label = QLabel("粤台产业科技学院 - 计算机视觉研究中心")
        title_label.setFont(QFont("Microsoft YaHei", 14, QFont.Bold))  # 底部标签稍微收敛字体到 14 号字
        title_label.setStyleSheet("color: #1A365D; padding-bottom: 5px;")
    ...
    def on_conf_changed(self, value):
        ...
        print(f"UI 调试：当前方案三的滑块值已改变为: {float_conf}")
