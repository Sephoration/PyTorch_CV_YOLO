...
# 1. 准备数据集
from read_dataset import train_data, test_data
...
# 4. 搭建神经网络模型
model = CIFAR10()
model.model1[8] = nn.Linear(64, 2)
# mode = model.add_module("linear", nn.Linear(10,2))
# model.load_state_dict(torch.load("steven_method2_1.pth"))
...
torch.save(model.state_dict(), "AntBee_1.pth")
writer.close()
